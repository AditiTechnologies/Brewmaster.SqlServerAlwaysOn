...
function Set-TargetResource
{
    ...
    if ($false -eq $bCheck)
    {
        ...
        osql -S $InstanceName -U sa -P $SAPassword -Q "GRANT ALTER ANY AVAILABILITY GROUP TO [NT AUTHORITY\SYSTEM] AS SA;"
        osql -S $InstanceName -U sa -P $SAPassword -Q "GRANT CONNECT SQL TO [NT AUTHORITY\SYSTEM] AS SA;"
        osql -S $InstanceName -U sa -P $SAPassword -Q "GRANT VIEW SERVER STATE TO [NT AUTHORITY\SYSTEM] AS SA;"
    }
